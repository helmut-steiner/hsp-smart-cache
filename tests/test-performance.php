...
class HSP_Cache_Performance_Test extends WP_UnitTestCase {
    ...
    public function test_lazy_loading_filters() {
        $img = HSP_Cache_Performance::filter_lazy_loading( true, 'img' );
        $iframe = HSP_Cache_Performance::filter_lazy_loading( true, 'iframe' );
        $this->assertTrue( $img );
        $this->assertTrue( $iframe );
    }

    public function test_decoding_async_added() {
        $attr = HSP_Cache_Performance::filter_image_attributes( array(), null, 'full' );
    ...
    public function test_dns_prefetch_hints_added() {
        ...
        $hints = HSP_Cache_Performance::add_dns_prefetch_hints( array(), 'dns-prefetch' );
